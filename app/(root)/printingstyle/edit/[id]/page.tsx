...
function page({params}:any) {
    ...
    const [fitting, setFittingStyle] = useState({
        name: '',
        status: ''
      });
    useEffect(() => {
  ...
  const handleSubmit = (event:any) => {
    ...
    axios.post(`http://localhost:4001/api/vs/fittingstyle/update/${id}`, fitting)
      .then(response => {
                  ...
                  />
                     ...
                     <SingleSelect
                      ...
                      value={{
                        ...
                        label:
                          options.find((option) => option.value === fitting.status)
                            ?.label || "",
                      }}
